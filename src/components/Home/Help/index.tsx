      ...
      <div className="container mx-auto lg:max-w-(--breakpoint-xl) px-4">
        <div className="text-center">
          ...
          <p className="text-muted dark:text-white/60 text-base">
            To deliver evidence-based clinical rehabilitation, community
            prevention, and professional mental health capacity building —
            empowering individuals and families to thrive in mind, body, and
            spirit.
            <br className="lg:block hidden" /> Our core areas of support
            include:
          </p>
