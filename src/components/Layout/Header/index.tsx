...
const Header: React.FC = () => {
  ...
  // Check for admin role — stored in the JWT token roles array
  const roles: string[] = (session as any)?.roles ?? [];
  const isAdmin = roles.some((r) =>
    ["ROLE_ADMIN", "ADMIN", "DEVELOPER"].includes(r)
  );
        ...
        <div className="hidden lg:flex items-center gap-3">
          {isAdmin && (
            <Link
              ...
              className="text-sm bg-primary hover:bg-darkprimary text-white px-4 py-3.5 leading-none rounded-lg font-medium text-nowrap transition-colors"
            >
              Admin Panel
            </Link>
          )}
          <button
            ...
            className="text-sm bg-dark hover:bg-dark/80 dark:bg-gray-700 dark:hover:bg-gray-600 text-white px-4 py-3.5 leading-none rounded-lg font-medium text-nowrap transition-colors"
          >
            Sign Out
          </button>
        </div>
  ...
  const MobileAuthButtons = () => {
        ...
        <div className="mt-4 flex flex-col space-y-4 w-full">
          {isAdmin && (
            <Link
              ...
              className="bg-primary text-white px-4 py-2 rounded-lg text-nowrap hover:bg-darkprimary text-center"
            >
              Admin Panel
            </Link>
          )}
          <button
            ...
            className="bg-transparent border border-gray-300 dark:border-gray-600 text-dark dark:text-white px-4 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 text-left"
          >
            Sign Out
          </button>
        </div>
    ...
    return (
      <div className="mt-4 flex flex-col space-y-4 w-full">
        <Link
          href="#"
          className="bg-transparent border border-primary text-primary px-4 py-2 text-nowrap rounded-lg hover:bg-darkprimary hover:text-white text-center"
          onClick={() => {
          ...
          <div className="flex items-center">
            <div className="flex gap-3 py-2 pr-6 border-r dark:border-dark_border">
              ...
              <div>
                ...
                >
                  goldenlifeinternational.kenya@gmail.com
                </Link>
              </div>
            </div>
