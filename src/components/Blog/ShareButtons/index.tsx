  ...
  return (
    <div className="flex gap-4 flex-col">
      ...
      <div className="bg-[#526fa3] py-4 px-6 text-20 rounded-lg text-white">
        ...
        >
          <svg className="me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="12.5px" height="20px">
      ...
      <div className="bg-[#46C4FF] py-4 px-6 text-20 rounded-lg text-white">
        <Link
          ...
          rel="noopener noreferrer"
        >
          <svg className="me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="21.5px" width="25px">
      ...
      <div className="bg-[#3C86AD] py-4 px-6 text-20 rounded-lg text-white">
        <Link
          href={`https://www.linkedin.com/shareArticle?mini=true&title=${encodeURIComponent(title)}&url=${encodeURIComponent(currentUrl)}`}
          className="flex items-center"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg className="me-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="21.5px" height="25px">
