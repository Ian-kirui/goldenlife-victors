...
export const ProgrammeData: {
...
}[] = [
  {
    ...
    title:
      "IMARA (Indigenous Movement for Addiction Recovery and Awareness) Program",
    slug: "imara",
...
export const Reviews: {
...
}[] = [
  {
    ...
    review:
      "Healing happens in connection. When we provide a safe, non-judgmental space for recovery—whether inside our clinical walls or out under a tree in a pastoralist community—we give people back their dignity and their future.",
    post: "CEO",
  },
];
