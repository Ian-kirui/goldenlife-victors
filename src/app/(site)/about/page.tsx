...
const PillarIcons = [
  ...
  <svg key="community" className="w-16 h-16" viewBox="0 0 64 64" fill="none">
    <circle cx="32" cy="18" r="6" stroke="currentColor" strokeWidth="2.5" />
    <circle cx="15" cy="30" r="5" stroke="currentColor" strokeWidth="2.5" />
...
const values = [
  {
    ...
    desc: "We treat every client with unconditional respect, creating a safe, non-judgmental space for healing.",
  },
  {
    title: "Evidence-Based Excellence",
    desc: "Our clinical interventions integrate proven medical, psychological, and therapeutic practices.",
  },
  {
    title: "Holistic Restorative Care",
    desc: "We address the whole person — bridging physical recovery, emotional resilience, family reintegration, and spiritual well-being.",
  },
  {
    title: "Community-Rooted Action",
    desc: "We believe true prevention happens where people live, work, learn, and worship.",
  },
  {
    title: "Integrity & Accountability",
    desc: "We maintain the highest ethical standards in patient care, financial management, and institutional partnerships.",
  },
];
...
const facilityFeatures = [
  {
    ...
    benefit:
      "Led by ICAP-certified addiction professionals, psychiatric nurse specialists, and clinical psychologists.",
  },
  {
    feature: "Serene Environment",
    benefit:
      "Located in Naivasha, offering a tranquil, nature-surrounded setting ideal for rest, reflection, and focus.",
  },
  {
    feature: "High Privacy & Dignity",
    benefit:
      "Strict confidentiality protocols to protect client identity and ensure a safe, non-judgmental space.",
  },
  {
    feature: "Holistic Integration",
    benefit:
      "Medical, psychological, social, and spiritual dimensions of health addressed under one care plan.",
  },
];
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-16 items-center">
            <div data-aos="fade-right" data-aos-duration="1000">
              ...
              <h2 className="text-4xl font-bold text-midnight_text dark:text-white mb-6 leading-tight">
                Driven by Compassion, Grounded in Science, Committed to Lasting
                Healing.
              </h2>
              <p className="text-muted dark:text-white/70 text-base leading-relaxed mb-4">
                We are an integrated mental healthcare, rehabilitation, and
                community wellness organisation dedicated to restoring human
                dignity across Kenya — from our specialised inpatient facility
                in Naivasha to grassroots communities.
              </p>
              <p className="text-muted dark:text-white/70 text-base leading-relaxed mb-6">
                Addiction and mental health challenges do not just affect an
                individual — they impact entire families and destabilise whole
                communities. GoldenLife Victors operates as a dual-impact
                organisation: delivering high-quality clinical rehabilitation
                while actively deploying preventive, community-driven mental
                health initiatives across schools, workplaces, faith
      ...
      <section className="py-20 bg-SnowySky dark:bg-darklight px-4">
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md)">
          ...
          >
            ...
            <p className="text-muted dark:text-white/70 text-base leading-relaxed mb-4">
              Mental health challenges and addiction do not exist in isolation —
              they affect individuals, families, and entire communities.
              GoldenLife Victors bridges the gap between clinical excellence and
              grassroots access.
            </p>
            <p className="text-muted dark:text-white/70 text-base leading-relaxed">
              Operating from our inpatient facility in Naivasha, Kenya, and out
              in the field across remote, pastoralist, urban, and institutional
              settings, we provide compassionate, multi-disciplinary care
      ...
      <section className="py-20 bg-SnowySky dark:bg-darklight px-4">
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md)">
          <div className="text-center mb-14" data-aos="fade-up">
            ...
            <h2 className="text-4xl font-bold text-midnight_text dark:text-white">
              What Sets Our Naivasha Facility Apart
            </h2>
          </div>
            ...
            {facilityFeatures.map((f, i) => (
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-midnight_text dark:text-white mb-1">
                      {f.feature}
                    </h4>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted dark:text-white/60 italic mb-4">
              Note: When using maps to find us, please call ahead to confirm the
              best route — GPS directions can sometimes suggest longer routes to
              our Naivasha location.
            </p>
            <Link
              href="/contact"
            ...
            {[
              {
                ...
                body: "GoldenLife Victors was established to address a critical gap: the need for accessible, dignified, and evidence-based mental health and addiction recovery services — replacing stigma with support, and despair with restored purpose.",
                icon: (
                  <svg
                    className="w-8 h-8"
                    fill="none"
      ...
      <section className="py-16 dark:bg-dark px-4">
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md)">
          <div
            className="bg-primary rounded-2xl px-8 py-12 text-center text-white"
            data-aos="fade-up"
          >
            ...
            <h3 className="text-3xl font-bold mb-4">
              Guided by Professional Leadership & Passion
            </h3>
            <p className="text-white/80 text-base max-w-2xl mx-auto mb-6">
              Our strength lies in our multidisciplinary team of psychiatrists,
              psychiatric nurse specialists, ICAP-certified addiction
              professionals, medical doctors, clinical psychologists,
              counsellors, and community health champions.
            </p>
            <Link
