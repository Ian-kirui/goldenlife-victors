...
export const metadata: Metadata = {
  ...
  description:
    "Preventive mental health education, support groups, and grassroots resilience initiatives for schools, mothers, faith communities, and young leaders across Kenya.",
};
        ...
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md)">
          ...
          >
            ...
            <p className="text-muted dark:text-white/70 text-base leading-relaxed mb-8">
              Preventive mental health education, specialised support groups,
              and grass-roots resilience initiatives tailored for schools,
              mothers, faith communities, and young leaders.
            </p>
          ...
          <div
            className="bg-primary/5 border border-primary/20 rounded-2xl p-8 mb-12 flex flex-col md:flex-row gap-6 items-center"
            data-aos="fade-up"
          >
            <div className="flex-1">
              ...
              <p className="text-muted dark:text-white/70 text-sm leading-relaxed mb-5">
                Indigenous Movement for Addiction Recovery & Awareness — our
                frontline initiative delivering culturally responsive,
                community-driven addiction recovery and mental health awareness
                to Kenya's pastoralist and indigenous communities through
                wellness caravans, youth empowerment, and cultural integration.
              </p>

              <Link
                href="/treatments/imara"
                className="inline-flex items-center justify-center bg-primary hover:bg-darkprimary text-white font-semibold px-6 py-2.5 rounded-lg transition-colors text-sm"
              >
            ...
            <div className="grid grid-cols-3 gap-4 shrink-0">
              {[
                ...
                <div
                  key={s.l}
                  className="text-center bg-white dark:bg-dark rounded-xl py-4 px-3"
                >
        ...
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md)">
          <div className="bg-primary rounded-2xl px-8 py-12 text-center text-white">
            ...
            <p className="text-white/80 text-base mb-8 max-w-xl mx-auto">
              Whether you represent a school, church, corporate team, or
              community organisation, we tailor our programmes to fit your
              specific needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
