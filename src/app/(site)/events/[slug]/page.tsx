...
import { getPublicEventById } from "@/utils/blogApi";
    ...
    <>
        ...
        <div className="container lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) mx-auto">
          <div className="grid md:grid-cols-12 grid-cols-1 items-start gap-8">
            ...
            <div className="col-span-4 flex flex-col gap-3 md:items-end">
              ...
              <Link href="/events" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary transition-colors">
                ← All Events
              </Link>
            </div>
          </div>
      ...
      <section className="pb-10 pt-12 dark:bg-dark lg:pb-20 px-4">
        <div className="container lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) mx-auto">
          ...
          {/* Cover image — natural aspect ratio, no forced height */}
          <div className="mb-12 rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800">
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div>
              <div className="bg-white dark:bg-[#1e2436] rounded-2xl border border-border dark:border-dark_border p-6 space-y-5 sticky top-28">
                <h3 className="font-bold text-midnight_text dark:text-white text-lg">Event Details</h3>
                <div className="space-y-4 text-sm">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-midnight_text dark:text-white font-medium">{formatPostDate(event.dateCreated)}</p>
                    </div>
                  </div>
                  {event.location && (
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-midnight_text dark:text-white font-medium">{event.location}</p>
                      </div>
                    </div>
                  )}
                  {event.meetLink && (
                    <div className="flex gap-3">
                      ...
                      <div>
                        <p className="text-xs text-gray-400 mb-0.5">Virtual Link</p>
                        <a href={event.meetLink} target="_blank" rel="noopener noreferrer"
                          className="text-primary font-medium hover:underline break-all">Join Meeting</a>
                      </div>
                    </div>
                  )}
                  {event.registrationLink && (
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        <a href={event.registrationLink} target="_blank" rel="noopener noreferrer"
                          className="text-secondary font-medium hover:underline break-all">Register Here</a>
                      </div>
                    </div>
                  )}
                  <div className="flex gap-3">
