...
export const metadata: Metadata = {
  ...
  description: "Upcoming and past events by GoldenLife Victors — workshops, therapy programmes, community outreaches and more.",
};
    ...
    <>
      ...
      <section className="py-20 dark:bg-dark px-4">
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md)">
          ...
          {/* Header */}
          <div className="flex items-center justify-between mb-12" data-aos="fade-up" data-aos-duration="800">
            <div>
              <p className="text-primary text-base font-medium mb-2">What's Happening</p>
              <h2 className="text-4xl font-bold text-midnight_text dark:text-white">
                Upcoming Events
              </h2>
            </div>
            <span className="text-sm text-gray-400">{published.length} event{published.length !== 1 ? "s" : ""}</span>
          </div>
          ...
          {published.length === 0 ? (
            <div className="text-center py-24 text-gray-400">
              ...
              <p className="text-lg font-medium">No upcoming events at this time.</p>
              <p className="text-sm mt-1">Check back soon — we're always planning something new.</p>
            </div>
          ) : (
