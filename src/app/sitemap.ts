...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/treatments`,                      priority: 0.9,  changeFrequency: "monthly" },
    { url: `${BASE_URL}/treatments/clinical-recovery`,    priority: 0.8,  changeFrequency: "monthly" },
    { url: `${BASE_URL}/treatments/community-outreach`,   priority: 0.8,  changeFrequency: "monthly" },
    { url: `${BASE_URL}/treatments/global-practices`,     priority: 0.8,  changeFrequency: "monthly" },
